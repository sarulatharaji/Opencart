...
//	    Retrieving first name
	    ...
	    fname.clear();
	    String firstName=sheet.getRow(4).getCell(1).getStringCellValue();
...
//	    Retrieving email
	    ...
	    String mail=sheet.getRow(6).getCell(1).getStringCellValue();
...
//	    Retrieving mobile number
	    ...
	    mobNo.clear();
	    String mobileNum=sheet.getRow(7).getCell(1).getStringCellValue();
...
//       Filling details in address page
        String firstNam=sheet.getRow(12).getCell(1).getStringCellValue();
...
//		Retrieving lastName
		String lastNam=sheet.getRow(13).getCell(1).getStringCellValue();
...
//		Filling company details
		String company=sheet.getRow(14).getCell(1).getStringCellValue();
		driver.findElement(By.name("company")).sendKeys(company);
		
//		Retrieving address 1
		String address1 =sheet.getRow(15).getCell(1).getStringCellValue();
...
//		Retrieving address 2
		String address2 =sheet.getRow(16).getCell(1).getStringCellValue();
...
//		Retrieving city
		String city =sheet.getRow(17).getCell(1).getStringCellValue();
		driver.findElement(By.id("input-city")).sendKeys(city);
		
//		Retrieving postcode
		String postcode =sheet.getRow(18).getCell(1).getStringCellValue();
